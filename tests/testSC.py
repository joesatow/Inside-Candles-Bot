...
def setVals(symbol, idx):
    global iValue
    global payloadObject
    ...
    # [0] = Daily, [1] = 4h
    payloadObjects = [
        {"s": symbol, "p": "D", "b": "6", "g": '0', 'i': iValue, 'r': millisecondsEpoch},
        {"s": symbol, "p:": "195", "b": "6", "g": "0", "i": iValue, 'r': millisecondsEpoch}
    ]
    payloadObject = payloadObjects[idx]
